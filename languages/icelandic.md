...
Verbs are negated with *ekki* "not" placed directly after the verb.

Preset Indicative, Imperative (tengdu?)
verb in second person + you = ertu or -ðu
...
-un {f} : =verb_to_noun <generally from class 4 weak verbs to denote the action done by that verb>
-st : =verb_to_middle_voice
...
sími {m} : telephone ; telephoe number <in definite form?>
penni {m} : pen
bók {f bókar bækur} : book
með [DAT/ACC] : with
spil {n} : game
krakki #informal : kid / child
strákur : boy 
fjölskylda : family
stelpa : girl
tala : to talk
setning {f} : sentence ; clause
hver : who
heyra : to hear
tungumál : language
  mál : language
...
ekki : not
afgreiðsla : attendance / service
hjá [DAT] : by / next to / at <as in at somebody's place>
núll : zero
einn {ett ein} : one / 1 ; a / an
tveir {tvö tvær} : two / 2
þrír {þrjú þrjár} : three / 3
fjórir {fjögur fjórar} : four / 4
fimm : five
sex : six
sjö : seven
átta : eigt
...
netfang {n} : e-mail address
samtal {n} : conversation
raða [DAT] : to put in order
í : to [ACC] ; in [DAT] ; for [ACC] <over a certain period of time>
...
bara : only / just
dagur : day
vinna {vann unnu unnið} : to work
lesa {las lásu lesið} : to read
hvar : where
skóli : school
  leikskóli : kindergarten / preschool
  málaskóla : language school
það : it
banki : bank
búð {f} : shop
leikur : game
...
tré {n} : tree ; wood
strætó {m} : city bus
hjól {n} : wheel ; tire <of bike or car> ; bike <short for reiðhjól>
hvenær : when
sunnudagur : Sunday
mánudagur : Monday
þriðjudagur : Tuesday
...
frí : vacation / holiday ; free
þá : then <both "in the past" and "in that case, therefore, after that">
vika : week
búinn : completed / finished
kústur : broom
blýantur : pencil
ostur : cheese
kaka : cake / cookie
...
ég tala smá islensku : I speak a little Icelandic
ertu að læra íslensku? : are you learning Icelandic?
afsakið... : excuse me...
ég skil ekki frönsku : I don't understand French
...
Finnland : Finland
  finnska : Finnish language
Frakkland : France
  franska {frönsku} : French language
  París : Paris
Holland : Netherlands
...
Japan {n} : Japan
  japanska {japönsku} : Japanese language
Kína : China
  kínverska : Chinese language
Lettland : Latvia
  lettneska : Latvian language
Litháen : Lithuania
  litháíska : Lithuanian language
Noregur : Norway
  norska : Norwegian language
Nýja-Sjáland : New Zealand
Palestína : Palestine
Perú : Peru
Pólland : Poland
  pólska : Polish language
Rússland : Russia
  rússneska : Russian language
Spánn {m} : Spain
  spænska : Spanish language
Svíþjóð {f} : Sweden
  sænska : Swedish language
Taíland : Thailand
  tælenska / taílenska : Thai language
Víetnam : Vietnam
  vietnamska {vietnömsku} : Vietnamese language
Þýskaland : Germany
  þýska : German language

arabiska : Arabic language
portúgalska {portúgölsku} : Portuguese language
```
